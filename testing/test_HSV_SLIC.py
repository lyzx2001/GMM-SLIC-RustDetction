...
if __name__ == '__main__':
    ...
    cv2.imwrite('./Output/Final_Img_HSV.png', finalImg)
    # display image (could be commented out)
    cv2.imshow('Final_Img_HSV', finalImg)
    cv2.waitKey(0)
    cv2.destroyAllWindows()
    
    cv2.imwrite('./Output/Binary_Img_HSV.png', binaryImg)
    # display image (could be commented out)
    cv2.imshow('Binary_Img_HSV', binaryImg)
    cv2.waitKey(0)
    cv2.destroyAllWindows()