...
if __name__ == '__main__':
    ...
    cv2.imwrite('./Output/Final_Img_RGB.png', finalImg)
    # display image (could be commented out)
    cv2.imshow('Final_Img_RGB', finalImg)
    cv2.waitKey(0)
    cv2.destroyAllWindows()
    
    cv2.imwrite('./Output/Binary_Img_RGB.png', binaryImg)
    # display image (could be commented out)
    cv2.imshow('Binary_Img_RGB', binaryImg)
    cv2.waitKey(0)
    cv2.destroyAllWindows()