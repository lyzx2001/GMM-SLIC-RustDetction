...
def classify(img_path, npy, ret = 255):
    ...
    cv2.imwrite('./Output/SLIC_Black_RGB.jpg', mask_slic)
    cv2.waitKey(0)
    cv2.destroyAllWindows()
    mask_inv_slic = cv2.bitwise_not(mask_slic)

    cv2.imshow('mask_inv_slic',mask_inv_slic)
    cv2.imwrite('./Output/SLIC_White_RGB.jpg', mask_inv_slic)
    cv2.waitKey(0)
    cv2.destroyAllWindows()
    ...
    cv2.waitKey(0)
    cv2.imwrite('./Output/SLIC_RGB.jpg', img_slic)
    cv2.destroyAllWindows()
...
if __name__ == '__main__':
    ...
    grey, prob = LoadModel('./GMMmodel_RGB.pkl', args.test_img_path, 7) 
    ...
    cv2.imshow('Final_Img_RGB', final_img)
    cv2.imwrite('./Output/Final_Img_RGB.jpg', final_img)
    cv2.waitKey(0)
    cv2.destroyAllWindows()
    cv2.imshow('Binary_Img_RGB', binary_img)
    cv2.imwrite('./Output/Binary_Img_RGB.jpg', binary_img)
    cv2.waitKey(0)
    cv2.destroyAllWindows()